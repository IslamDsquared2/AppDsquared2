    ...
    return (
        <>
            ...
            <div className='flex flex-col w-[100vw] h-[calc(100vh-90px)] justify-center items-center'>
                ...
                {isLoading && (
                    <div role="status">
                    <svg aria-hidden="true" class="w-8 h-8 mr-2 text-gray-200 animate-spin dark:text-gray-600 fill-[#2ecc71]" viewBox="0 0 100 101" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                {xmlData && (
                    <div>
                        ...
                        <button className='select-file-label downloaded m-2' onClick={() => UploadFiles('uploadCategorisation', xmlData)}>
