    ...
    if (file) {
      ...
      reader.onload = (e) => {
        ...
        while (worksheet['A' + row]) {
          ...
          if (currentProductId && (currentV1Link || currentV2Link)) {
            xmlRecords.push(`
      ...
      >
        ...
        <div className='flex flex-col w-[100vw] h-[calc(100vh-90px)] justify-center items-center'>
          ...
          <p>Use this tool to generate the XML for the video in version V1 and V2<br />
            Click <span className='download-underline' onClick={() => downloadTemplate('templateVideoVimeo')} >here</span> to download the template </p>
